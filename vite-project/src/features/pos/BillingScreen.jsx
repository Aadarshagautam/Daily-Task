        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                          ...
                          <tr key={c.productId} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-3 text-right">
                              <input
                                ...
                                className="w-20 px-2 py-1 border border-gray-200 rounded text-right text-sm focus:outline-none focus:ring-1 focus:ring-indigo-500"
                              />
                            </td>
          ...
          <div className="space-y-4">
              ...
              {selectedCustomer ? (
                <div className="flex items-center justify-between p-3 bg-indigo-50 rounded-lg">
                  <div>
                    ...
                    <p className="text-xs text-indigo-600">{selectedCustomer.phone || "No phone"}</p>
                  </div>
                  <button onClick={() => setSelectedCustomer(null)} className="p-1 hover:bg-indigo-100 rounded">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <input
                  ...
                  className="w-24 px-2 py-1 border border-gray-200 rounded text-right text-sm focus:outline-none focus:ring-1 focus:ring-indigo-500"
                />
              </div>
              <div className="flex justify-between text-sm">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3.5 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-colors font-semibold text-base disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {saleMut.isPending ? (
