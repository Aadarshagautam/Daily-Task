...
const PrintableInvoice = ({ sale }) => {
  ...
  return (
    <>
      {/* A4 Invoice */}
      <div className="bg-white rounded-xl border border-gray-200 p-8 print:border-0 print:shadow-none print:p-4">
        {/* Header */}
        <div className="flex justify-between items-start mb-8 print:mb-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 print:text-xl">INVOICE</h1>
            <p className="text-sm text-gray-500 mt-1">{sale.invoiceNo}</p>
          </div>
        ...
        {/* Customer Info */}
        {customer && (
          <div className="mb-6 p-4 bg-gray-50 rounded-lg print:bg-transparent print:border print:border-gray-300 print:p-2">
        ...
        <table className="w-full text-sm mb-6">
          <thead>
            <tr className="border-b-2 border-gray-200">
              ...
              <th className="text-right py-2 font-medium text-gray-600">Disc.</th>
              <th className="text-right py-2 font-medium text-gray-600">Tax</th>
            ...
            {sale.items.map((item, i) => (
              <tr key={i}>
                ...
                <td className="py-2">
                  ...
                  {item.skuSnapshot && (
                    <p className="text-xs text-gray-400">{item.skuSnapshot}</p>
                  )}
                </td>
        ...
        {/* Totals */}
        <div className="border-t-2 border-gray-200 pt-4 ml-auto max-w-xs">
