    ...
    <div className="p-4 lg:pl-[17.5rem] pt-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">POS Products</h1>
            <p className="text-sm text-gray-500">Manage your retail products</p>
          </div>
          <button
            onClick={openCreate}
                ...
                <tbody className="divide-y divide-gray-100">
                  {products.map((p) => (
                    <tr key={p._id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-right text-gray-600">Rs. {p.costPrice}</td>
                      <td className="px-4 py-3 text-right font-medium text-gray-900">Rs. {p.sellingPrice}</td>
                      <td className="px-4 py-3 text-right">
                        <span className={`font-medium ${p.stockQty <= (p.lowStockAlert || 10) ? "text-red-600" : "text-green-600"}`}>
                          {p.stockQty}
                        </span>
                      </td>
                      <td className="px-4 py-3 text-right text-gray-600">{p.taxRate}%</td>
                      <td className="px-4 py-3">
