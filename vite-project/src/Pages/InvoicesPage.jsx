    ...
    return (
      <div className="lg:ml-64 flex items-center justify-center h-screen bg-slate-50">
        <div className="text-center">
          ...
          <p className="text-lg font-medium text-slate-700">Loading invoices...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-slate-600">Manage and track all your invoices in one place.</p>
          </div>
          <Link
            to="/invoices/new"
        ...
        <div className="bg-white rounded-xl p-6 border border-green-200 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">{stats.paidCount} invoice{stats.paidCount !== 1 ? 's' : ''}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-amber-200 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">{stats.unpaidCount} invoice{stats.unpaidCount !== 1 ? 's' : ''}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-red-200 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Require attention</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="p-4">
          <div className="relative max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 text-sm transition-colors"
            />
          </div>
        </div>
      </div>
      ...
      {filteredInvoices.length > 0 && (
        <div className="mt-6 bg-white rounded-xl border border-slate-200 shadow-sm p-4">
          <div className="flex items-center justify-between text-sm text-slate-600">
            <p>
              Showing <span className="font-semibold text-slate-900">{filteredInvoices.length}</span>{' '}
              of <span className="font-semibold text-slate-900">{safeInvoices.length}</span> invoice
