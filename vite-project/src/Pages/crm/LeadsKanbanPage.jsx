                      ...
                      >
                        ...
                        <div className="flex items-start justify-between mb-2">
                          <div className="flex items-center gap-1 min-w-0">
                            ...
                            <h3 className="text-sm font-semibold text-gray-800 truncate">{lead.name}</h3>
                          </div>
                        ...
                        {/* Source badge */}
                        <span className="text-[10px] px-2 py-0.5 rounded-full font-medium bg-gray-100 text-gray-600 capitalize">
                          {(lead.source || 'other').replace('_', ' ')}
                        </span>

                        {/* Contact icons */}
                        <div className="flex items-center gap-2 mt-2 pt-2 border-t border-gray-100">
                          {lead.email && <Mail className="w-3 h-3 text-gray-400" title={lead.email} />}
                          {lead.phone && <Phone className="w-3 h-3 text-gray-400" title={lead.phone} />}
                          {lead.notes?.length > 0 && (
