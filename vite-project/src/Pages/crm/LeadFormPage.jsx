    ...
    <div className="lg:ml-64 mt-16 min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200 px-6 py-5">
        <button
          ...
          className="flex items-center gap-2 text-slate-500 hover:text-slate-700 mb-3 text-sm transition-colors group"
        >
        ...
        <form onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-400 focus:border-transparent text-sm"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-400 focus:border-transparent text-sm bg-white"
                  >
                    {SOURCES.map(s => (
              ...
              <div className="p-6">
                ...
                {notes.length > 0 ? (
                  <div className="space-y-3 mb-5">
                    {notes.map((note, i) => (
                      <div key={note._id || i} className="bg-slate-50 rounded-lg p-3 border border-slate-100">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-400 focus:border-transparent text-sm"
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-4 py-2 bg-slate-900 text-white rounded-lg text-sm font-medium hover:bg-slate-800 disabled:opacity-50 transition-colors"
                  >
          ...
          <div className="flex items-center gap-3">
            <button
              type="submit"
              disabled={saving}
              className="flex items-center gap-2 px-6 py-2.5 bg-slate-900 text-white rounded-lg font-medium hover:bg-slate-800 disabled:opacity-50 transition-colors"
            >
              {saving ? (
                <>
