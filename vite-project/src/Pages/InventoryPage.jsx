  ...
  return (
    <div className="ml-64 p-8 bg-slate-50 min-h-screen">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-600">Track and manage your shop's product inventory.</p>
      </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-slate-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-slate-900">{'\u20B9'}{stats.totalProfit.toLocaleString()}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-slate-200 mb-6">
          ...
          <form onSubmit={editingItem ? handleUpdateItem : handleCreateItem} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">Low Stock Alert</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">VAT Rate (%)</label>
                <input
                  type="number"
            ...
            <table className="w-full">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                  ...
                  <th className="px-6 py-3 text-right text-xs font-medium text-slate-500 uppercase">Cost Price</th>
                  <th className="px-6 py-3 text-right text-xs font-medium text-slate-500 uppercase">Selling Price</th>
                  <th className="px-6 py-3 text-right text-xs font-medium text-slate-500 uppercase">Profit/Unit</th>
                ...
                {filteredInventory.map((item) => {
                  ...
                  return (
                    <tr key={item._id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-right text-sm text-slate-900">{'\u20B9'}{item.costPrice.toLocaleString()}</td>
                      <td className="px-6 py-4 text-right text-sm text-slate-900">{'\u20B9'}{item.sellingPrice.toLocaleString()}</td>
                      <td className="px-6 py-4 text-right">
                        <span className={`text-sm font-semibold ${profit > 0 ? 'text-green-600' : 'text-red-600'}`}>
                          {'\u20B9'}{profit.toLocaleString()}
                        </span>
                      </td>
                      <td className="px-6 py-4 text-center text-sm text-slate-600">{item.vatRate || 0}%</td>
